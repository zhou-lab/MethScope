...
```{r}
#2025_ZhouPseudo_binstring_sub
#2025_ZhouPseudo_binstring_major
...
ggsave("~/figures/fuh1/20250429_Zhou2025_major_hyper.pdf",width=6,height=4)
...
ggplot(sortedFrequency_df, aes(x = pattern_number, y = Cumulative_Freq, group = 1, 
  ...
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1),
        text = element_text(size = 11)) + guides(size = "none") + scale_y_continuous(breaks = pretty_breaks(n = 6))


ggsave("~/figures/fuh1/20240429_cumulative_CGs_Zhou.pdf",width=5,height=4)
