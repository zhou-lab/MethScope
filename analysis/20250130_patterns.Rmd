...
Pattern_annotation <- read.table(text=system("yame unpack ~/cell_type/Tool/MethScope/inst/extdata/Liu2021_MouseBrain.cm", intern=TRUE), header=F)
...
```{r}
library(data.table)
A <- read.table(text=system("yame unpack ~/cell_type/Tool/MethScope/inst/extdata/Zhou2025_HumanAtlas.cm", intern=TRUE), header=F)
B <- read.table(text=system("yame unpack ~/cell_type/Tool/MethScope/inst/extdata/Loyfer2023_HumanAtlas.cm", intern=TRUE), header=F)
