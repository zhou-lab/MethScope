...
for (i in 1:1000){
  ...
  write.table(patterns_out_enrich,"~/zhoulab/labprojects/20231112_Hongxiang/20251117_Loyfer_pattern.txt",quote=FALSE,col.names = FALSE,row.names = FALSE)
  text <- paste0("yame pack ~/zhoulab/labprojects/20231112_Hongxiang/20251117_Loyfer_pattern.txt -fb ~/zhoulab/labprojects/20231112_Hongxiang/20251117_Loyfer_pattern/",i,".cg")
  system(text)
}

# mergeCG2 ~/zhoulab/labprojects/20231112_Hongxiang/20251117_Loyfer_pattern/ ~/zhoulab/labprojects/20231112_Hongxiang/20251117_Loyfer_pattern_1000.cg
# yame summary -m /home/fuh1/references/hg38/KYCGKB_hg38/Chromosome.20221129.cm ~/zhoulab/labprojects/20231112_Hongxiang/20251117_Loyfer_pattern_1000.cg > ~/zhoulab/labprojects/20231112_Hongxiang/20251117_Loyfer_pattern_1000_chr

library(dplyr)
library(tidyr)
Chr_enrichment <- read.table("~/zhoulab/labprojects/20231112_Hongxiang/20251117_Loyfer_pattern_1000_chr",header=T)
...
Chr_enrichment_sex_enrich <- Chr_enrichment_sex %>% filter(Log2OddsRatio >= 2)
...
Chr_enrichment_sex_enrich_list <- c("P90","P641","P723","P949")
...
wrap_plots(plots)
ggsave("~/figures/fuh1/20251118_Sex_pattern_chrX.pdf",width=5,height=5)
...
Rscript ./GenerateReference.R ~/intermediate/20251118_Loyfer_binstring
