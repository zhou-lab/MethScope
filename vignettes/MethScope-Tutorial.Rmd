...
Cell type proportions can be estimated with our nnls_deconv functions, to obtain the reference input, please check out our (https://github.com/zhou-lab/methscope_data) which stores the reference pseudo bulk .cg files.

```{r,eval=FALSE}
reference_pattern <- system.file("extdata", "Liu2021_MouseBrain.cm", package = "MethScope")
reference_input <- GenerateInput("2021_LiuMajorTypePseudo.cg",reference_pattern)
reference_input <- imputeRowMean(reference_input)
