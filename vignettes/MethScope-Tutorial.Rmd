...
Inspect the resulting sample-by-pattern matrix:

```{r, eval=FALSE}
# full preview
head(input_pattern)

# optional: focus on the first 10 MRMP columns for readability
head(input_pattern[, 1:10])

# check dimensions (samples x patterns)
dim(input_pattern)
```
